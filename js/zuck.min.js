...
"","\n</div>")}},language:{unmute:"Sentuh Memunyikan",keyboardTip:"Tekan spasi ke berikutnya",visitLink:"Kunjungi link",time:{ago:"lalu",hour:"1 jam lalu",hours:"Berapa jam lalu",minute:"1 menit lalu",minutes:"Berapa menit lalu",fromnow:"Baru saja",seconds:"Berapa detik lalu",yesterday:"Kemarin",tomorrow:"Besok",days:"Berapa hari lalu"}}},z=function(){var a=f("#zuck-modal");a||n.Zuck.hasModal||(n.Zuck.hasModal=!0,a=document.createElement("div"),a.id="zuck-modal",h("cubeEffect")&&(a.className="with-cube"),a.innerHTML=
